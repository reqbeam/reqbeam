...
This document describes the migration of the CLI from REST API calls to direct database access using the `@reqbeam/db` package.
...
**File**: `reqbeam-cli/package.json`
- Added `@reqbeam/db` as a local dependency

### 2. Database Connection Manager

**File**: `reqbeam-cli/src/utils/db.ts` (NEW)
...
**File**: `reqbeam-cli/src/utils/apiStorage.ts`
