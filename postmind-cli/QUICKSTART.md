...
**Important**: The CLI connects directly to the database using the shared library. You need to:
...
The database connection is centralized in the shared library - you don't need to configure it separately for the CLI.
