...
helpCommand
  ...
  .action(async (commandName?: string) => {
    if (commandName) {
      ...
      console.log(chalk.cyan(`  postmind ${commandName} --help\n`));
      return;
    }

    // Show general help menu
    console.log(chalk.bold('\n📚 Postmind CLI - Help Menu\n'));
    console.log(chalk.gray('A TypeScript-based CLI tool for managing API projects, environments, requests, and collections'));
    console.log(chalk.gray('All data is synced with the Postmind web UI in real-time.\n'));

    console.log(chalk.bold('🔐 Authentication\n'));
    console.log(chalk.cyan('  auth login          ') + chalk.gray('Login to Postmind web UI'));
    console.log(chalk.cyan('  auth logout         ') + chalk.gray('Logout from Postmind web UI'));
    console.log(chalk.cyan('  auth status         ') + chalk.gray('Check authentication status'));
    console.log(chalk.gray('  Example: postmind auth login\n'));
    ...
    console.log(chalk.gray('  Example: postmind workspace list\n'));
    ...
    console.log(chalk.gray('  Example: postmind collection create "My API"\n'));
    ...
    console.log(chalk.gray('  Example: postmind request create -i\n'));
    ...
    console.log(chalk.gray('  Example: postmind env list\n'));
    ...
    console.log(chalk.gray('  Example: postmind run request "Get Users"\n'));
    ...
    console.log(chalk.gray('  Example: postmind test run\n'));
    ...
    console.log(chalk.gray('  Example: postmind logs list\n'));

    console.log(chalk.bold('📖 Additional Help\n'));
    console.log(chalk.gray('  • Use "pm" as a shorter alias for "postmind"'));
    console.log(chalk.gray('  • Get help for a specific command: postmind <command> --help'));
    console.log(chalk.gray('  • Example: postmind auth --help'));
