...
authCommand
  .command('login')
  .description('Login to Postmind (opens browser for authentication)')
  ...
  .action(async (options: {
    ...
    try {
      ...
      console.log(chalk.bold('Postmind CLI Authentication'));
      ...
      if (!authData) {
        ...
        console.log(chalk.yellow('\nYou can try:'));
        console.log(chalk.cyan('  pm auth login --email <email> --password <password>'));
